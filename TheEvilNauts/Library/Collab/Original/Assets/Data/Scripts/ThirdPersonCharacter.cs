...
namespace UnityStandardAssets.Characters.ThirdPerson
{
    ...
    public class ThirdPersonCharacter : MonoBehaviour
	{
        ...
        void Start()
        {
            ...
            slot1 = transform.FindChild("vochap_metarig").FindChild("root").FindChild("hips").FindChild("spine").FindChild("chest").FindChild("SLOT_1");
            chest = transform.FindChild("vochap_metarig").FindChild("root").FindChild("hips").FindChild("spine").FindChild("chest");
            hand = transform.FindChild("vochap_metarig").FindChild("root").FindChild("hips").FindChild("spine").FindChild("chest").FindChild("shoulder.R").FindChild("upper_arm.R").FindChild("forearm.R").FindChild("hand.R");
